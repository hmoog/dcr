...
The key claim is that this triad constitutes the \emph{minimal and
universal} signature of cognition, and that it is realized by
physical law itself at every scale.
...
\end{enumerate}
We adopt reading~(2) because it yields the most parsimonious
ontology: one process at every scale, rather than cognition as a
sui generis phenomenon.  All formal results hold under either
reading.
\end{remark}
...
$\Viol$ on average (energy is a martingale under detailed balance).
...
In practice, the non-product hypothesis~\ref{eq:non-product-hyp}
